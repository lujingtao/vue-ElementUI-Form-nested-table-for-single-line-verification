...
// module
exports.push([module.i, ".el-table .cell{overflow:visible}.el-form-item{margin-bottom:0}.el-form-item__error{padding-top:0;margin-top:-3px}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('h3',[_vm._v("vue+ElementUI 表单嵌套表格逐行校验（新增、编辑）的完美解决方案")]),_vm._v(" "),_c('p',[_vm._v("--大话主席")]),_vm._v(" "),_c('el-form',{ref:"form",attrs:{"model":_vm.form,"rules":_vm.rules}},[_c('el-table',{staticStyle:{"width":"100%"},attrs:{"data":_vm.form.datas,"highlight-current-row":""}},[_c('el-table-column',{attrs:{"prop":"id","label":"序号","width":"60"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"name","label":"姓名"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [(scope.row.action == 'view')?[_vm._v("\n            "+_vm._s(scope.row.name)+"\n          ")]:[_c('el-form-item',{attrs:{"prop":'datas.'+scope.$index + '.name',"rules":_vm.rules.name}},[_c('el-input',{staticStyle:{"width":"120px"},attrs:{"size":"mini"},model:{value:(scope.row.name),callback:function ($$v) {_vm.$set(scope.row, "name", (typeof $$v === 'string'? $$v.trim(): $$v))},expression:"scope.row.name"}})],1)]]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"name","label":"年龄"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [(scope.row.action == 'view')?[_vm._v("\n            "+_vm._s(scope.row.age)+"\n          ")]:[_c('el-form-item',{attrs:{"prop":'datas.'+scope.$index + '.age',"rules":_vm.rules.age}},[_c('el-input',{staticStyle:{"width":"60px"},attrs:{"size":"mini"},model:{value:(scope.row.age),callback:function ($$v) {_vm.$set(scope.row, "age", _vm._n($$v))},expression:"scope.row.age"}})],1)]]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"operation","label":"操作"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [(scope.row.action == 'view')?[_c('el-button',{attrs:{"size":"mini"},on:{"click":function($event){return _vm.click_edit(scope.row, scope.$index)}}},[_vm._v("编辑")]),_vm._v(" "),_c('el-button',{attrs:{"size":"mini"},on:{"click":function($event){return _vm.click_delete(scope.row, scope.$index)}}},[_vm._v("删除")])]:(scope.row.action == 'add')?[_c('el-button',{attrs:{"size":"mini"},on:{"click":function($event){return _vm.click_add( scope.row, scope.$index)}}},[_vm._v("新增")]),_vm._v(" "),_c('el-button',{attrs:{"size":"mini"},on:{"click":function($event){return _vm.click_reset(scope.row, scope.$index)}}},[_vm._v("重置")])]:[_c('el-button',{attrs:{"size":"mini"},on:{"click":function($event){return _vm.click_save(scope.row, scope.$index)}}},[_vm._v("保存")]),_vm._v(" "),_c('el-button',{attrs:{"size":"mini"},on:{"click":function($event){return _vm.click_cancle(scope.row, scope.$index)}}},[_vm._v("取消")])]]}}])})],1)],1)],1)}
var staticRenderFns = []
...
var update = __webpack_require__(173)("95517ffc", content, true, {});
...
/* harmony default export */ __webpack_exports__["a"] = ({
  data() {
    return {
      form: {
        datas: [{ id: 1, name: "张三", age: 20 }, { id: 2, name: "李四", age: 32 }]
      },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_61b713a2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(171);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_61b713a2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_element_ui_lib_theme_chalk_index_css__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__App_vue__ = __webpack_require__(75);
...
//# sourceMappingURL=index.js.map?9fc2d6ed334018a92448